...
static const char DM_GENERATE[] =
    ...
    "Each action needs a clear applicability condition, useful bounded output and a completion condition. "
    "Use shell loops for deterministic batches, reserving decisions for choices needing interpretation. "
    "Print relevant matches, counts and errors; store bulky evidence in files rather than dumping it. "
    "During repair, preserve completed work and unresolved requirements; do not blindly repeat commands. "
